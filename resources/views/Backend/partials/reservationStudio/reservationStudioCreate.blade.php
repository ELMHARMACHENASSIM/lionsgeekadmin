                    ...
                    <form class="studioReservationForm" action={{ route('reservationStudio.store', $studio) }} method="POST">
                        ...
                        <div class="">
                            <div class=" flex justify-center items-center mt-4">
                                <div class="w-[90%]">
                                    <label class="fw-bold" for="finish_hour">Équipe</label>
                                    <input type="text" name="search" id="search" placeholder="Entrer member name"
                                        class="form-control mt-2" onfocus="this.value=''">
                                </div>
                            </div>
                            <div class="d-flex align-items-center  justify-content-center">

                                <div id="search_list" class="w-[90%] "></div>
                            </div>
                            <script>
                        ...
                        <div class="text-center mt-4">
                            <button class="btn btn-noir w-[50%] rounded" type="submit">Create Reservation</button>
                        </div>
                    </form>
                @endif
            @endforeach
