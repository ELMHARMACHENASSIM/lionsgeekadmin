@props(['title' => __('Confirmer le mot de passe'), 'content' => __('Pour des raisons de securite veuillez entrer votre mot de passe avant de activer le 2fa.'), 'button' => __('Confirmer')])
