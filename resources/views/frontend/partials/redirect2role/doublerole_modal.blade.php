<!-- Modal -->
<div class="modal fade" id="reservemodaldoublerole" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row d-flex justify-content-center align-items-center flex-column gap-2 -bottom-3">
                    ...
                    <div class="col-md-6 linkreserve">
                        ...
                        <a href="{{ route('reservationClasse.indexfront') }}" class="text-decoration-none">
                    ...
                    <div class="col-md-6 linkreserve">
                        ...
                        <a href="{{ route('reservationStudio.indexfront') }}" class="text-decoration-none">
                            <div class="card h-100 p-8 d-flex align-items-center justify-center  bgimage"
