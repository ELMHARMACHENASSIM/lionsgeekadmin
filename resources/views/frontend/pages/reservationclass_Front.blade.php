            ...
            <tbody>
                @foreach ($classes as $index => $classe)
                    <tr>
                        ...
                        <td class="col-30">
                            <div id="carouselExamplefront{{ $index }}" class="carousel slide widthslide">
                                ...
                                <button class="carousel-control-prev prvbtn" type="button"
                                    data-bs-target="#carouselExamplefront{{ $index }}" data-bs-slide="prev">
                                ...
                                <button class="carousel-control-next nxtvbtn" type="button"
                                    data-bs-target="#carouselExamplefront{{ $index }}" data-bs-slide="next">
                        ...
                        <td class="col-30">
                            <a href={{ route('reservationClassefront.info', $classe) }}>
